                ...
                <table class="border-solid border-4 border-coyos-lightpink  max-w-full">
                    <thead>
                        <tr class="border-solid border-4 border-coyos-lightyellow">
                            ...
                            <td class="p-3 font-bold uppercase bg-coyos-lightblue text-gray-600 border-r-4 border-coyos-darkblue text-center lg:table-cell">¿Qué ordenaste?</td>
                        ...
                        @foreach ($pedidos as $pedido)
                            <tr class="border-solid border-4 border-coyos-lightpink px-2">
                                ...
                                @if ($pedido->status=='ENTREGADO')
                                    <td colspan="2" class="px-2 py-4 text-center border-solid border-r-4  border-coyos-darkpink">
                                        <p class="text-center align-middle text-xl-center mx-2 text-green-700  text-2xl px-2 py-2 text-bold ">Pedido entregado y disfrutado.</p>
                                    </td>
                                @else
                                    <td class="px-2 text-center border-solid border-r-4 border-coyos-darkblue">
                                        <form action="">
                                            <button class="text-center align-middle shadow-outline-indigo  hover:bg-coyos-lightblue mx-2 hover:text-coyos-darkpink bg-coyos-darkpink text-coyos-lightblue rounded text-xl px-2 py-2 text-bold">¿Cancelar?</button>
                                        </form>
                                    </td>
