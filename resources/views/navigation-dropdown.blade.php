<nav x-data="{ open: false }" class="border-b bg-coyos-lightbrown border-coyos-lightbrown">
    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('pedidos_cliente.index') }}" :active="request()->routeIs('pedidos.index')">
                        {{ __('Your Orders') }}
                    </x-jet-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-slot name="trigger">
                        ...
                        @else
                            <button class="flex items-center text-sm font-medium text-gray-800 transition duration-150 ease-in-out hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300">
                                ...
                                <div class="ml-1">
                                    <svg class="w-4 h-4 fill-current bg-coyos-midbrown" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
